...
1. Download **`ClipBord 0.1.4.dmg`** from the [Releases](../../releases) page.
2. Open the DMG file.
...
This project follows [Semantic Versioning](https://semver.org/). The current release is `0.1.4`.
